...
(function() {
    ...
    const translations = {
        en: {
            ...
            'settings.callTimer': 'Show call duration',
            'calltimer.title': 'Call duration',
            // Select options
            'opt.off': 'off',
            'opt.default': 'default',
            'opt.none': 'none',
            ...
            'quality.lost': 'Connection lost, reconnecting…',
            'quality.peerWeak': '{who}: the connection has weakened — video may stutter.',
            'quality.peerBad': '{who}: the connection is poor — sound and video may break up.',
            'quality.peerLost': '{who}: connection lost. Reconnecting…',
            'quality.peerRestored': '{who}: the connection is back to normal.',
            'quality.selfWeak': 'Your connection has weakened — others may see and hear you with delays.',
            'quality.selfBad': "Your internet can't keep up. Try turning off your camera.",
            'quality.selfLost': 'Your connection dropped. Reconnecting…',
            'quality.selfRestored': 'Your connection is back to normal.',
            'quality.everyone': 'The connection is poor with everyone at once — the problem is probably on your side. Try turning off your camera.',
            'quality.anonymous': 'Participant',
            'tile.micOff': 'Microphone off',
            ...
            'e2ee.privateBlocked': 'Not sent: this group requires end-to-end encryption, and a private message cannot be encrypted',
            ...
            'e2ee.blockedOverlay': 'Unencrypted connections are blocked in this room, and this call cannot be end-to-end encrypted, so nothing is being sent.',
            'e2ee.blockedWhy.multipeer': 'There are more than two people here, and this encryption covers exactly two.',
            'e2ee.blockedWhy.unsupported': 'This browser cannot encrypt a call.',
            'e2ee.blockedWhy.peerUnsupported': 'The other person\'s browser cannot encrypt a call.',
            'e2ee.blockedWhy.transform': 'The encryption could not be started in this browser.',
            // Browser support
        ...
        ru: {
            ...
            'nav.exitFullscreen': 'Выйти из полного экрана',
            ...
            'settings.callTimer': 'Показывать время звонка',
            'calltimer.title': 'Время звонка',
            'opt.off': 'выкл',
            ...
            'quality.peerWeak': '{who}: связь ухудшилась — видео может подтормаживать.',
            'quality.peerBad': '{who}: связь плохая — звук и видео могут прерываться.',
            'quality.peerLost': '{who}: связь потеряна. Переподключаемся…',
            'quality.peerRestored': '{who}: связь восстановилась.',
            'quality.selfWeak': 'Ваша связь ухудшилась — вас могут видеть и слышать с задержками.',
            'quality.selfBad': 'Ваш интернет не справляется. Попробуйте выключить камеру.',
            'quality.selfLost': 'Ваше соединение прервалось. Переподключаемся…',
            'quality.selfRestored': 'Ваша связь восстановилась.',
            'quality.everyone': 'Связь плохая сразу со всеми — скорее всего, проблема на вашей стороне. Попробуйте выключить камеру.',
            'quality.anonymous': 'Участник',
            'tile.micOff': 'Микрофон выключен',
            ...
            'e2ee.privateBlocked': 'Не отправлено: в этой комнате обязательно сквозное шифрование, а личное сообщение зашифровать нельзя',
            ...
            'e2ee.blockedOverlay': 'В этой комнате включена блокировка незашифрованных соединений, а этот звонок зашифровать нельзя — поэтому ничего не отправляется.',
            'e2ee.blockedWhy.multipeer': 'Участников больше двух, а это шифрование рассчитано ровно на двоих.',
            'e2ee.blockedWhy.unsupported': 'Этот браузер не умеет шифровать звонок.',
            'e2ee.blockedWhy.peerUnsupported': 'Браузер собеседника не умеет шифровать звонок.',
            'e2ee.blockedWhy.transform': 'В этом браузере не удалось запустить шифрование.',
            // Поддержка браузера
